...
export default function NavBar({ aboutData }) {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 shadow md:shadow-none shadow-slate-50 opacity-90 sm:opacity-90 rounded-2xl bg-transparent z-10 block md:flex w-11/12  sm:w-9/12 sm:mx-auto mx-auto mt-5 justify-between items-center">
