...
export default function UserDetailsForm() {
  ...
  return (
    <div
      className={` ${
        isMounted ? "slide-in5" : ""
      } opacity-0sm:w-11/12 md:w-4/5 mx-auto sm:pt-20 relative font-ubuntu `}
    >
            ...
            {currentForm === "welcomePara" ? (
              <div className="px-5 flex justify-center items-end h-80 mb-20">
                <div>
                  ...
                  >
                    <span className=" text-3xl text-indigo-600"> Welcome!</span>{" "}
                    <br />
                  ...
                  <div className="w-full flex justify-end">
                    <button
                      ...
                      className="py-1 border text-gray-600 border-indigo-400 hover:text-white hover:bg-indigo-500 rounded-2xl px-10 "
                    >
                      Start
                    </button>
                  </div>
